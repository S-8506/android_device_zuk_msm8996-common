...
# Kernel
BOARD_KERNEL_CMDLINE := console=tty androidboot.hardware=qcom user_debug=23 msm_rtb.filter=0x3F androidboot.hardware=qcom  ehci-hcd.park=3 lpm_levels.sleep_disabled=1 cma=16M@0-0xffffffff
